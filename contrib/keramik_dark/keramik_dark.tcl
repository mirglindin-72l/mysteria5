...
#
# edited as keramik_dark

package require Tk 8.6-

namespace eval ttk {
    namespace eval theme {
        namespace eval keramik_dark {
            variable version 0.6.2
        }
    }
}

namespace eval ttk::theme::keramik_dark {
    ...
    LoadImages [file join [file dirname [info script]] keramik_dark]

    ttk::style theme create keramik_dark -parent alt -settings {
...
package provide ttk::theme::keramik_dark $::ttk::theme::keramik_dark::version

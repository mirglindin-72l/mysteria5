...
Word SetHyperlink $rangeLink "https://www.cawt.tcl3d.org" "Hyperlink to valid URL"
Word AppendParagraph $docId
incr valid(url)

set rangeLink [Word AppendText $docId "Dummy"]
Word SetHyperlink $rangeLink \
     "https://www.cawt.tcl3d.org/download/CawtReference-Cawt.html#::Cawt::CheckBoolean" \
...
set rangeLink [Word AppendText $docId "Dummy"]
Word SetHyperlink $rangeLink \
     "https://www.cawt.tcl3d.org/download/CawtReference_Cawt.html#::Cawt::CheckInvalidProc" \
     "Hyperlink to invalid URL index"
Word AppendParagraph $docId
incr invalid(url)

set rangeLink [Word AppendText $docId "Dummy"]
Word SetHyperlink $rangeLink "https://www.cawt.tcl3d.org/dummy.html" "Hyperlink to invalid URL"
Word AppendParagraph $docId
incr invalid(url)

set rangeLink [Word AppendText $docId "Dummy"]
Word SetHyperlink $rangeLink "https://www.wrongcawt.tcl3d.org/index.html" "Hyperlink to invalid domain"
Word AppendParagraph $docId
incr invalid(url)

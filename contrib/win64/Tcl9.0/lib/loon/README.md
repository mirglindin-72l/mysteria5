...
please create an issue report at [tclImageScale GitHub](https://github.com/waddella/tclImageScale) or email [contact Adrian Waddell](mailto:adrian@waddell.ch).

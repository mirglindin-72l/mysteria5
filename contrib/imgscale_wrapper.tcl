...
critcl::cflags -Wall -Os -c -I/opt/homebrew/Cellar/tcl-tk/9.0.3/include/tcl-tk -DUSE_TCL_STUBS -DUSE_TK_STUBS -ltclstub9.0 -ltkstub9.0
critcl::ldflags -Os
...
critcl::cinit {
	char s[32];
	Tcl_CreateNamespace(ip, "::imgscale", NULL, NULL);
	sprintf(s, "69");
	Tcl_SetVar2Ex(ip, "::imgscale::version", NULL, Tcl_NewStringObj(s, -1), 0);
} {}

critcl::ccommand ::imgscale::imgscale {cdata interp objc objv} {
/*
